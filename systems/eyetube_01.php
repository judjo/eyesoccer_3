...
$cmd=mysqli_query($con,"insert into tbl_eyetube (title,admin_id,category_name,description,thumb,thumb1,video,createon) values ('$title','".$_SESSION["admin_id"]."','$category_name','$description','$thumb','$thumb1','$video','$now')"); 
header("refresh:0");
}
?>	
...
$query=mysqli_query($con,"SELECT a.*,b.fullname FROM tbl_eyetube a LEFT JOIN tbl_admin b ON b.admin_id=a.admin_id where eyetube_id order by eyetube_id desc");
