...
<h1 id="t2"><i class="fa fa-newspaper-o"></i> KATEGORI EYETUBE</h1>
<hr></hr>
<div class="row form-group">
<div class="col-lg-9 col-md-9"><a data-toggle="modal" data-target="#m1" class="btn" id="btn5">ADD</a></div>
<div class="col-lg-3 col-md-3">
<form method="get" action="lists_eyetubecategory">
...
<div id="m1" class="modal fade" role="dialog">
  <div class="modal-dialog" id="set9">
    ...
    <div class="modal-header text-center"><h1 id="t3">Add Kategori Eyetube</h1></div>
    ...
    $cmd=mysqli_query($con,"insert into tbl_category_eyetube (admin_id,category_name) values ('".$_SESSION["admin_id"]."','$category_name')");    
           header("refresh:0");
      }	
      ?>	
    <div class="form-group text-left" id="t1">Nama Kategori<input type="text" name="category_name" class="form-control" id="ipt1" required></div>    
...
$result=mysqli_query($con,"SELECT a.*,b.fullname FROM tbl_category_eyetube a LEFT JOIN tbl_admin b ON b.admin_id=a.admin_id where category_eyetube_id order by category_eyetube_id desc");
while($data = mysqli_fetch_array($result))
{
$category_eyetube_id=$data['category_eyetube_id'];	
$category_name=$data['category_name'];


print'<tr>
<td>'.$category_name.'</td>
<td><a href="eyetubecategory_edit?admin_id='.$admin_id.'&category_eyetube_id='.$category_eyetube_id.'" class="btn" id="btn3">EDIT</a>&emsp;<a href="eyetubecategory_delete?admin_id='.$admin_id.'&category_eyetube_id='.$category_eyetube_id.'" class="btn" id="btn4">DELETE</a></td>
</tr>';
}
