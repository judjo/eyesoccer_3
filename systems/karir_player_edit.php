...
$cmd=mysqli_query($con,"select * from tbl_karir_player where karir_id='$karir_id'");
...
<form method="post" enctype="multipart/form-data">
      	...
      	if(isset($_POST['opt2'])){
			...
			$cmd=mysqli_query($con,"update tbl_karir_player set bulan='".$bulan."',tahun='".$tahun."',klub='".$klub."',turnamen='".$turnamen."',negara='".$negara."',jumlah_main='".$jumlah_main."',no_pg='".$no_pg."',pelatih='".$pelatih."',updateon='".date('Y-m-d H:i:s')."' where karir_id='".$karir_id."'");
