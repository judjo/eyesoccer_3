...
<h1 id="t2"><i class="fa fa-user fa-lg"></i> UPDATE GALLERY PLAYER</h1>
...
// echo "update tbl_gallery set pic='".$pic."',thumb1='".$thumb1."',updateon='".date('Y-m-d H:i:s')."' where player_id='".$player_id."'";exit();
		...
		<div class="col-lg-6 col-md-6" id="t1"><img src="player_storage/<?php echo $row['pic'];?>" class="form-control img-responsive" id="ipt1" style="height:auto;"></div>
