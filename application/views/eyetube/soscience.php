...
<br><br>
<div class="col-xs-12 col-sm-12"><div class="row" style="padding:2px;" id="a99"><a href="<?=base_url()?>eyetube/matchpreview" class="btn btn-warning btn-block" style="background:#13689C;color:#fff;border:solid #13689C 1px;">Match Preview</a></div></div>
</div><br>
<?php
		$cmd1=$this->db->query("SELECT * FROM tbl_eyetube where title like'%soccer sains%' order by eyetube_id desc");
